...
```bash
# dịch (Kaggle) — luôn thử --dry-run trước
python -m chessvi.data.translate --dataset <c1_data_id> --split sft --limit 20 --dry-run
python -m chessvi.data.translate --dataset <c1_data_id> --split sft --backend hf --resume
